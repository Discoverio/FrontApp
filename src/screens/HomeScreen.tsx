    ...
    render() {
        return (
            ...
            <View>
                ...
                <Card style={[s.m4, s.m0_b]}><Text style={[s.backgroundColor, s.extraColor, s.fs36, s.p2, s.w700]}>Music</Text></Card>
                
                <DeezerWidget album_id={this.state.randomAlbumId} />

                <Card style={[s.m4, s.m0_b]}><Text style={[s.backgroundColor, s.extraColor, s.fs36, s.p2, s.w700]}>Movie</Text></Card>
